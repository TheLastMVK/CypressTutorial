...
describe('Suite de pruebas de Login',{includeShadowDom:true},() =>{
    ...
    it('click for position',()=>{
        ...
        //conjunto de lables .action-labels es el padre, se utiliza hacer al mismo tiempo click
        cy.get(".action-labels>.label").click({multiple:true})

        //cuando quiero acceder a un botón que está ocupado por otra objeto.
