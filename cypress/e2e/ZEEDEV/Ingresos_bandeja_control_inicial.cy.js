...
describe('Creacion de Registro',() =>{
    it('Creacion de Registro',()=>{      
        ...
        cy.get('span[class="mat-content ng-tns-c50-12"]').click()
        cy.wait(1000)     
        ...
        /////////////////////REGISTRO DOCUMENTO PARTE 1//////////////////////////////
        cy.get("body>main>div:nth-child(4)>mf-ingreso>ingreso-nuevo>div>menu-datosingreso>form>div>div>mat-form-field:nth-child(3)>div").click() 
